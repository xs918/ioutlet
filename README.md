...
4. This will deploy `target/ioutlet.ear` to the running instance of the server.
...
The application will be running at the following URL <http://localhost:8080/ioutlet>.
